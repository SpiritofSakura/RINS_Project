...
ARGUMENTS = [
    ...
    DeclareLaunchArgument('world', default_value='task1_green_demo', description='Simulation World'),
    ...
    DeclareLaunchArgument('map', default_value=PathJoinSubstitution([pkg_dis_tutorial3, 'maps', 'map.yaml']), description='Full path to map yaml file to load')
]
